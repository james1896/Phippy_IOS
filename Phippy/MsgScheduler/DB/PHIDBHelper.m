    ...
    dispatch_once(&onceToken, ^{
        ...
        if ([db open]) {
            ...
            /*
             ...
             rank integer);"
             */
            BOOL result_store = [db executeUpdate: @"CREATE TABLE IF NOT EXISTS t_store (id integer PRIMARY KEY AUTOINCREMENT,store_id integer NOT NULL,store_type integer NOT NULL,name text,img_url text,phone_numer text,wechat text,deliver_time text,qisong_condition text,adress text,rank integer);"];
